(function () {
  ...
  const COPY = {
    'zh-CN': {
      ...
      qrTitle: '客户订阅二维码', qrHint: '请让终端客户使用支持 HWID 的订阅客户端扫描，默认仅允许 1 台设备。Karing 扫码后需先开启 X-HWID 再确认导入。',
    ...
    'en-US': {
      ...
      qrTitle: 'Customer subscription QR', qrHint: 'Scan with an HWID-capable client. One device is allowed by default. In Karing, enable X-HWID before importing.',
